    ...
    <div className="dash-layout">
      ...
      <div className="dash-sidebar">
        ...
        <div className="dash-nav">
          ...
          <div className="dash-nav-item" onClick={() => navigate('/result')}>My Results</div>
        ...
        {profile ? (
          <div className="dash-ai-panel">
            ...
            <div className="dai-content">
              ...
              <button className="dai-btn" onClick={() => navigate('/result')}>
          ...
          {eligible.length > 0 && (
            <div className="dash-panel">
              <div className="dash-panel-header">
                ...
                <button className="dash-ghost-btn" onClick={() => navigate('/result')}>View All</button>
              </div>
