...
export const HeroButton = React.forwardRef(({ className, transition, ...props }, ref) => {
  return (
    <motion.button
      ...
      ref={ref}
      className={cn(
        "group relative flex w-fit items-center rounded-full border border-[#4f46e5] bg-gray-950/10 px-4 py-2 shadow-[0px_4px_24px_rgba(79,70,229,0.4)] transition-colors hover:bg-slate-950/50",
        className
      )}
      {...props}
    />
